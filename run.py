        ...
        if choice == "1":
            ...
            if hitchance > 3:
                ...
                if enemy.health > 1:
                    ...
                    print("But wait!", enemy.name,
                          "dropped something of value")
                    lootDrop = loot()
                ...
                print(
                    "You look class holding your gun sideways but sadly you miss", enemy.name)
            ...
            if runchance > 4:
                ...
                print(
                    "As you try to run, your leather snags on something and you slip\n")
                print(
